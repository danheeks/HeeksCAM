...
{
	leftControls.push_back(MakeLabelAndControl(_("Sketches"), m_cmbSketch = new HTypeObjectDropDown(this, ID_SKETCH, SketchType, &(wxGetApp())), m_btnSketchPick = new wxButton(this, ID_SKETCH_PICK, _("Pick"))));
...
void SketchOpDlg::PickSketch()
{
	...
	wxGetApp().PickObjects(_("Pick a sketch"), MARKING_FILTER_SKETCH_GROUP, true);
