...
Python CDepthOp::AppendTextToProgram()
{
	...
	python << _T("float(") << m_depth_op_params.m_clearance_height / wxGetApp().m_program->m_units << _T(")");
	python << _T(", float(") << m_depth_op_params.m_rapid_safety_space / wxGetApp().m_program->m_units << _T(")");
    python << _T(", float(") << m_depth_op_params.m_start_depth / wxGetApp().m_program->m_units << _T(")");
    python << _T(", float(") << m_depth_op_params.m_step_down / wxGetApp().m_program->m_units << _T(")");
    python << _T(", float(") << m_depth_op_params.m_z_finish_depth / wxGetApp().m_program->m_units << _T(")");
    python << _T(", float(") << m_depth_op_params.m_z_thru_depth / wxGetApp().m_program->m_units << _T(")");
    python << _T(", float(") << m_depth_op_params.m_final_depth / wxGetApp().m_program->m_units << _T(")");
