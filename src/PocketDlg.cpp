...
void PocketDlg::GetDataRaw(HeeksObj* object)
{
	...
	((CPocket*)object)->m_zig_unidirectional = m_chkZigUnidirectional->GetValue();
...
void PocketDlg::SetFromDataRaw(HeeksObj* object)
{
	...
	m_chkZigUnidirectional->SetValue(((CPocket*)object)->m_zig_unidirectional);
...
{
	PocketDlg dlg(wxGetApp().m_frame, object);
